        ...
        <div className="flex flex-row items-start pt-[30px]">
          ...
          <div className="flex flex-col ml-[145px] mt-[10px]">
            ...
            <ul className="mt-[30px] space-y-2">
              <li><a href="/" className="text-gray-600 hover:text-[#255d60] hover:underline transition">Home</a></li>
              <li><a href="/agama/islam" className="text-gray-600 hover:text-[#255d60] hover:underline transition">Agama</a></li>
              <li><a href="/berita" className="text-gray-600 hover:text-[#255d60] hover:underline transition">Berita</a></li>
              <li><a href="/tentang" className="text-gray-600 hover:text-[#255d60] hover:underline transition">Tentang</a></li>
            </ul>
          </div>
